            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed right-0 top-0 h-full w-80 bg-[#1B1B1D] border-l border-white/10 z-50 overflow-y-auto"
                    >
                        {/* Header */}
                        ...
                        {/* Footer */}
                        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10 bg-[#1B1B1D]">

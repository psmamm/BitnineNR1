          ...
          >
            ...
            <div className="px-6 pt-4">
              <div className="flex gap-2">
                <div className={`flex-1 h-1 rounded-full ${step >= 1 ? 'bg-[#00D9C8]' : 'bg-zinc-700'}`} />
                <div className={`flex-1 h-1 rounded-full ${step >= 2 ? 'bg-[#00D9C8]' : 'bg-zinc-700'}`} />
              </div>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-zinc-800 border ${errors.name ? 'border-red-500' : 'border-zinc-700'} rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-[#00D9C8] transition-colors`}
                    />
                        ...
                        <button
                          ...
                          className={`flex items-start gap-3 p-3 rounded-xl border transition-all text-left ${
                            formData.strategy === strategy.id
                              ? 'bg-[#00D9C8]/10 border-[#00D9C8] text-white'
                              : 'bg-zinc-800/50 border-zinc-700 text-zinc-300 hover:border-zinc-600'
                          }`}
                        >
                          <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center mt-0.5 ${
                            formData.strategy === strategy.id ? 'border-[#00D9C8]' : 'border-zinc-600'
                          }`}>
                            {formData.strategy === strategy.id && (
                              <div className="w-2 h-2 rounded-full bg-[#00D9C8]" />
                            )}
                          </div>
                          <div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-zinc-300 mb-2">
                      <div className="flex items-center gap-2">
                        <Target className="w-4 h-4 text-[#00D9C8]" />
                        Trading Pair
                      </div>
                    </label>
                    <select
                      ...
                      className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-xl text-white focus:outline-none focus:border-[#00D9C8] transition-colors"
                    >
                      {SYMBOLS.map((symbol) => (
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-zinc-800 border ${errors.maxPositionSize ? 'border-red-500' : 'border-zinc-700'} rounded-xl text-white focus:outline-none focus:border-[#00D9C8] transition-colors`}
                    />
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-zinc-800 border ${errors.stopLoss ? 'border-red-500' : 'border-zinc-700'} rounded-xl text-white focus:outline-none focus:border-[#00D9C8] transition-colors`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-zinc-800 border ${errors.takeProfit ? 'border-red-500' : 'border-zinc-700'} rounded-xl text-white focus:outline-none focus:border-[#00D9C8] transition-colors`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-zinc-800 border ${errors.riskPerTrade ? 'border-red-500' : 'border-zinc-700'} rounded-xl text-white focus:outline-none focus:border-[#00D9C8] transition-colors`}
                      />
            ...
            <div className="flex items-center justify-between p-6 border-t border-zinc-800">
              {step === 1 ? (
                <>
                  ...
                  <Button onClick={handleNext} className="bg-[#00D9C8] hover:bg-[#00A89C]">
                    Next Step
                  </Button>
                </>
              ) : (

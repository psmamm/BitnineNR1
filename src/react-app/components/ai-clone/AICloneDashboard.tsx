...
export function AICloneDashboard() {
  ...
  return (
    <div className="space-y-6">
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#FCD535] to-[#00A89C] flex items-center justify-center">
                  ...
                  return (
                    <motion.div
                      ...
                      className={`flex items-center gap-3 p-3 rounded-xl transition-all ${
                        isActive
                          ? 'bg-[#FCD535]/10 border border-[#FCD535]/30'
                          : isCompleted
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        {isActive && step.message && (
                          <p className="text-xs text-[#FCD535]">{step.message}</p>
                        )}
                      </div>
                ...
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xl font-mono font-semibold text-[#FCD535]">
              ...
              {(trainingProgress.status === 'completed' || trainingProgress.status === 'error') && (
                <Button
                  className="w-full bg-[#FCD535] hover:bg-[#00C4B4] text-black font-medium"
      ...
      <Card className="glass border-[#FCD535]/30 bg-gradient-to-br from-[#FCD535]/5 to-transparent">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                disabled={isTraining}
                className="bg-[#FCD535] hover:bg-[#00C4B4] text-black font-semibold px-6 py-3 h-auto text-base shadow-lg shadow-[#FCD535]/20 hover:shadow-[#FCD535]/30 transition-all"
              >
                {isTraining ? (
                  <>

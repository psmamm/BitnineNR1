  ...
  const actions = [
    {
      ...
      color: 'bg-gradient-to-r from-[#FCD535] to-[#FFE066] hover:from-[#7B47FF] hover:to-[#9B6AFF]',
      badge: null,
    },
    {
      title: 'View Journal',
      ...
      color: 'bg-gradient-to-r from-[#FCD535] to-[#27AE60] hover:from-[#FCD535] hover:to-[#229954]',
      ...
      <div className={`${getCardBg(theme)} rounded-xl p-4 border ${getCardBorder(theme)} h-full`}>
        ...
        <div className="space-y-3">
          {actions.map((action, index) => (
            ...
            >
              <div className={`${action.color} p-3 rounded-xl transition-all shadow-md group-hover:shadow-lg group-hover:shadow-[#FCD535]/20 relative`}>

  ...
  return (
    <DashboardLayout>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="w-12 h-12 rounded-xl border-zinc-800 hover:border-[#00D9C8]/50"
            >
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="relative overflow-hidden rounded-2xl bg-zinc-900/50 border border-zinc-800/50 p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="w-11 h-11 rounded-xl bg-[#00D9C8]/10 flex items-center justify-center">
          ...
          <div className="flex items-center justify-between p-6 border-b border-zinc-800/50">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-[#00D9C8]/15 flex items-center justify-center">
                <PieChart className="w-6 h-6 text-[#00D9C8]" />
              </div>
              <div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl bg-zinc-900/50 border border-zinc-800/50 overflow-hidden">
            ...
            <div className="p-6">
              ...
              {/* Best Day Highlight */}
              <div className="mt-4 p-4 rounded-xl bg-[#00D9C8]/5 border border-[#00D9C8]/20">
                <div className="flex items-center gap-3">
                  <Award className="w-5 h-5 text-[#00D9C8]" />
                  <div>
                    <p className="text-sm text-[#00D9C8] font-medium">
                ...
                {insights.training_history.map((training, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="text-center">
                        <p className="text-lg font-mono font-bold text-[#00D9C8]">
        ...
        <motion.div
          variants={itemVariants}
          className="rounded-3xl bg-[#00D9C8]/5 border border-[#00D9C8]/20 p-6"
        >
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-xl bg-[#00D9C8]/20 flex items-center justify-center">
              <Zap className="w-6 h-6 text-[#00D9C8]" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-[#00D9C8]">AI Recommendations</h3>
              <ul className="mt-3 space-y-2">
                <li className="flex items-start gap-2 text-sm text-zinc-300">
                  <ArrowUpRight className="w-4 h-4 text-emerald-400 mt-0.5 shrink-0" />
                  Focus on trading during{' '}
                  <span className="font-medium text-[#00D9C8]">
                ...
                <li className="flex items-start gap-2 text-sm text-zinc-300">
                  ...
                  <span className="font-mono font-medium text-[#00D9C8]">

              ...
              <div className="space-y-3 max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
                {smartMoneyAlerts.map((alert, index) => (
                  <motion.div
                    ...
                    className="p-3 bg-[#1B1B1D] rounded-lg border border-[#2B2F36] hover:bg-white/5 cursor-pointer transition-all group"
                  >
            ...
            <div className="bg-[#1B1B1D] rounded-xl p-4 border border-[#2B2F36]">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                {keyCoins.slice(0, 6).map((coin) => (
                  <div key={coin.symbol} className="p-3 bg-[#1B1B1D] rounded-lg border border-[#2B2F36] hover:bg-white/5 transition-colors">
                    <div className="flex items-center space-x-2">
                      <img
                        src={coin.logo}
                        alt={coin.symbol}
